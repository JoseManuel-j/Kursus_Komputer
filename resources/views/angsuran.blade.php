...
<div class="main-content">
    ...
    <div class="mb-4">
        ...
        <p class="text-muted">Berikut ini adalah riwayat pembayaran angsuran kelas yang Anda ikuti.</p>
    </div>

    <!-- Cek apakah user memiliki pendaftaran kelas -->
    @if($pendaftaran)
    
        <!-- Kartu Info Ringkasan (Bagian Atas) -->
                    ...
                    <div class="col-md-6">
                        <table class="table table-borderless table-sm mb-0">
                            <tr>
                                ...
                                <td class="fw-medium">REG-{{ str_pad($pendaftaran->id, 5, '0', STR_PAD_LEFT) }}</td>
                            </tr>
                            <tr>
                                <td class="text-muted">Program Kelas</td>
                                <td>:</td>
                                <td class="fw-medium">{{ $pendaftaran->nama_program }}</td>
                            </tr>
                            <tr>
                                <td class="text-muted">Total Tagihan</td>
                                <td>:</td>
                                <td class="fw-bold" style="color: #7c3aed;">Rp {{ number_format($pendaftaran->total_biaya, 0, ',', '.') }}</td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-md-6">
                        <table class="table table-borderless table-sm mb-0">
                            <tr>
                                ...
                                <td style="width: 10px;">:</td>
                                <td class="fw-medium text-danger">Rp {{ number_format($sisaBayar, 0, ',', '.') }}</td>
                            </tr>
                            <tr>
        ...
        <!-- Kartu Tabel Detail Angsuran (Bagian Bawah) -->
                    ...
                    <table class="table table-hover align-middle table-bordered text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>2600{{ $t->id }}</td>
                                <!-- Menggunakan tanggal dibuatnya tagihan untuk tgl kwitansi -->
                                <td>{{ isset($t->created_at) ? \Carbon\Carbon::parse($t->created_at)->format('d M Y') : '-' }}</td>
                                <!-- Asumsi batas bayar adalah 30 hari setelah tagihan dibuat -->
                            ...
                            @empty
                            <tr>
                                <td colspan="6" class="text-muted py-4">Belum ada riwayat tagihan atau angsuran.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
